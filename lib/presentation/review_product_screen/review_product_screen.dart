...
import 'package:habibur_s_application4/widgets/custom_rating_bar.dart';
...
class ReviewProductScreen extends GetWidget<ReviewProductController> {
  ...
  /// Common widget
  Widget _buildProfilePicture({required String userName}) {
  ...
  /// Common widget
  Widget _buildProfilePicture1({required String userName}) {
    return Row(children: [
      CustomImageView(
